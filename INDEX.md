...
- [v3 design — inadequacy notice and coping](scratch/v3-design.md) — load when scoping the v3 architecture (notice→act two-stage; behavioral signal catalog from prompt + response; classification-driven effort routing; v2+v3 bidirectional wiring; v3 phases v3.0-v3.4 with acceptance criteria; v4 deferred items including user-feedback intake design). Contains lock candidates needing sign-off before migrating to CLAUDE.md.
