...
// pkg/adapter/hermes/instructions.go (and pkg/adapter/ollama/
// instructions.go) on purpose for v0. The prompts are
// substrate-agnostic — they describe the v0 playbook protocol, not
// anything LM-Studio-specific — and consolidating them into a shared
// package is a future refactor (worth doing once a third substrate
// motivates it; with hermes + ollama + lmstudio + vllm coming online
// the case for consolidation is getting strong).
//
// If you change a prompt here, change it in hermes / ollama too, or
// the adapters will drift in subtle ways the bench will then have to
// untangle.
