...
// pkg/adapter/hermes/instructions.go on purpose for v0. The prompts
// are substrate-agnostic — they describe the v0 playbook protocol,
// not anything Hermes-specific — and consolidating them into a
// shared package is a future refactor (worth doing once a third
// substrate lands, not before).
//
// If you change a prompt here, change it in hermes too, or the two
// adapters will drift in subtle ways the bench will then have to
// untangle.
